...
class Balvanchik(mobs.Vrag):
    def __init__(self, igrok: battles.BattlePers, name: str, walls_list: arcade.SpriteList):
        ...
        self.reakciya = 40
        self.vel_x = self.walk_vel_x = VRAG_VEL_X
    ...
    def on_update(self, delta_time: float = 1 / 60) -> None:
        ...
        if not self.oglush and not self.kast_scena and not self.oglush_for_sposob:
...
class First(mobs.Vrag):
    ...
    def update_animation(self, delta_time: float = 1 / 60) -> None:
        ...
        self.animations.poiman_animation()
        if not self.animations.poiman:
            self.animations.idle_animation(self.change_x)
