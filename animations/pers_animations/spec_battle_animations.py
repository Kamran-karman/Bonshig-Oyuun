...
class OyuunAnimations(pers_animations.BattleAnimations):
    def __init__(self, pers: battles.VodaPers):
        ...
        self.fall_texture = arcade.load_texture_pair(f'{main_patch}jump_fall/fall.png')
        self.block_texture = arcade.load_texture_pair(f'{main_patch}jump_fall/fall.png')
...
class GorozhanenAnimations(pers_animations.BattleAnimations):
    def __init__(self, sprite: BattlePers):
        super().__init__(sprite)
        main_patch = self.main_patch + "male_person/malePerson_"
        ...
        self.slovar_animation[BEG][1] = 3
        self.slovar_animation[BEG][3].load_textures(4, f"{main_patch}walk", PNG)
...
class OpolchenecAnimations(pers_animations.BattleAnimations):
    def __init__(self, sprite: BattlePers):
        super().__init__(sprite)
        main_patch = self.main_patch + "female_adventurer/femaleAdventurer_"
...
class PolicAnimations(pers_animations.BattleAnimations):
    def __init__(self, sprite: BattlePers):
        super().__init__(sprite)
        main_patch = self.main_patch + 'male_adventurer/maleAdventurer_'
